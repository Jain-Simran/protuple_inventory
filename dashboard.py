...
class IMS:
    def __init__(self,root):
        ...
        #====title====
        self.icon_title=PhotoImage(file="C:\\Users\\simran\\Downloads\\Project Pic\\logo1.png")
        ...
        #===========LeftMenu=========================
        self.MenuLogo=PhotoImage(file="C:\\Users\\simran\\Downloads\\Project Pic\\menu2.png")     
       
        LeftMenu=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        LeftMenu.place(x=0,y=102,width=200,height=469)
        lbl_menuLogo=Label(LeftMenu,image=self.MenuLogo)
        lbl_menuLogo.pack(side=TOP,fill=X)
        self.icon_side=PhotoImage(file="C:\\Users\\simran\\Downloads\\Project Pic\\side.png")
